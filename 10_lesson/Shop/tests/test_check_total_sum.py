...
class TestCheckTotalSum:
    ...
    @allure.title("Test. Проверка корректности отображения суммы покупки")
    @allure.id("Shop-1")
    @allure.feature("Автоматический расчет суммы покупки")
    @allure.description(""" Добавляем товары в корзину и
                        проверяем правлильность подсчета суммы заказа""")
