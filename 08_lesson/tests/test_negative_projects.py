...
class TestNegativeAccess:
    @pytest.mark.negative
    def test_negative_get_project_by_non_existent_id(self,
                                                     project_service:
                                                     ProjectService):
    ...
    def test_negative_update_non_existent_id(self,
                                             project_service: ProjectService):
        non_existing_project_id = NON_EXISTENT_ID
